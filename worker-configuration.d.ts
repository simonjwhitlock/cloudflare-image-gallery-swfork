/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3cd4c6357aa9b47441781de89b61f1ca)
// Runtime types generated with workerd@1.20260828.1 2026-01-05
interface __BaseEnv_Env {
  IMAGES_BUCKET: R2Bucket;
  ADMIN_PATH: '/photoadmin';
  ACCESS_TEAM_DOMAIN: 'whitlockiow.cloudflareaccess.com';
  IMAGE_INDEX: DurableObjectNamespace<import('./src/index').ImageIndex>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'ImageIndex';
  }
